...
namespace Samba.Modules.TicketModule
{
    public class TicketListViewModel : ObservableObject
    {
        ...
        public CaptionCommand<string> NewTicketCommand { get; set; }
        ...
        {
            return false;// SelectedTicket != null && !SelectedTicket.IsPaid;
        }
        ...
        private bool CanCreateNewTicket(string obj)
        {
            if (SelectedTicket == null) return false;
            if (SelectedTicket.Items.Count > 0)
            {
                return true;
            }
            return false;
        ...
        private void OnCreateNewTicket(string obj)
        {
            ...
            {
                // SelectedTicket.FixSelectedItems();
         //       var newTicketId = AppServices.MainDataContext.NewTicket().TicketId;
