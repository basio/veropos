...
html
{
  font-family: 'Courier New', monospace;
    ...
    public static class LocalSettings
    {
        ...
        public static string DocumentPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\Vero"; } }

        public static string DataPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\Vero Tech\\Vero"; } }
        public static string UserPath { get { return Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Vero Tech\\Vero"; } }

        public static string CommonSettingsFileName { get { return DataPath + "\\VeroSettings.txt"; } }
        public static string UserSettingsFileName { get { return UserPath + "\\VeroSettings.txt"; } }
        ...
        public static IList<string> SupportedLanguages { get { return new[] { "en", "ar" }; } }
